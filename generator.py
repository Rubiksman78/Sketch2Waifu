...
class Encoder(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.conv1 = Generator_block(in_channels, out_channels, kernel_size=7, padding=0)
...
class Decoder(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.decode = nn.Sequential(
            ...
            nn.Conv2d(in_channels=out_channels//2, out_channels=3, kernel_size=7, padding=0),
        )
...
class Generator(nn.Module):
    def __init__(self, input_size, output_size,rs_blocks=8):
